                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('VendorProfileController@changepass',['id' => $vendor->id]) !!}" class="form-horizontal form-label-left">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Mot de passe actuel<span class="required">*</span>
                                </label>
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="slug"> Nouveau mot de passe<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number"> Confirmer le nouveau mot de passe<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button id="update_pass" type="submit" class="btn btn-success btn-block">Changer le mot de passe</button>
                                </div>
                            </div>
                        </form>
                    </div>
