...
<head>
    ...
    <!-- Custom CSS -->
    <link href="{{ URL::asset('/css/genius-admin.css')}}" rel="stylesheet">
...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="{!! url('admin/dashboard') !!}">
            <img class="logo" src="{!! url('/images/logo') !!}/{{$settings[0]->logo}}" alt="LOGO">
        </a>
    </div>
    <!-- Top Menu Items -->
...
<script type="text/javascript" src="{{ URL::asset('/js/plugin/nicEdit.js')}}"></script>
<script type="text/javascript" src="{{ URL::asset('/js/admin-genius.js')}}"></script>
