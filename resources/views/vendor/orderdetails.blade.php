                ...
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <table class="table">
                            <tbody>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Commande ID#</strong></td>
                            ...
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Email du coopérative:</strong></td>
                                <td>{{$order->customer_email}}</td>
                            </tr>
                            <tr>
                                <td width="30%" style="text-align: right;"><strong>Numéro du téléphone de coopérative:</strong></td>
