            ...
            <div class="row" id="main">
                ...
                <div class="go-title">
                    <div class="pull-right">
                        <a href="{!! url('vendor/products') !!}" class="btn btn-default btn-back"><i class="fa fa-arrow-left"></i> retour</a>
                    </div>
                    ...
                    <div class="panel-body">
                        ...
                        <form method="POST" action="{!! action('VendorProductsController@store') !!}" class="form-horizontal form-label-left" enctype="multipart/form-data">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Nom du produit<span class="required">*</span>
                                    <p class="small-label"></p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input id="name" class="form-control col-md-7 col-xs-12" name="title" placeholder="Nom du produit" required="required" type="text">
                                </div>
                            </div>

                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Catégorie du produit<span class="required">*</span>
                          ...
                          <!--  <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name"> Image du produit <span class="required">*</span>
                                </label>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                                   <img style="max-width: 250px;" src="" id="adminimg" alt=" Aucun image choisie">
                                </div>
                                <div class="col-md-3 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="number"> Gallerie du produit <span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <div class="checkbox">
                                        <label><input type="checkbox" name="pallow" id="allow" value="1"><strong>Ajouter la taille du produit</strong></label>
                                    </div>
                                </div>
                            </div>

                            <div class="item form-group" id="pSizes" style="display: none;">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12" for="name">Tailles du produit<span class="required">*</span>
                                    <p class="small-label">(Ajouter les tailles séparés par [,])</p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12"> Description du produit<span class="required">*</span>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <!--   <div class="item form-group">
                            ...
                            <div class="item form-group">
                                <label class="control-label col-md-3 col-sm-3 col-xs-12">Stock du produit<span class="required">*</span>
                                    <p class="small-label"></p>
                                </label>
                                <div class="col-md-6 col-sm-6 col-xs-12">
                         ...
                         <!--   <div class="item form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-6 col-md-offset-3">
                                    <button id="add_ads" type="submit" class="btn btn-success btn-block">Ajouter un produit</button>
                                </div>
                            </div>
                        </form>
                    </div>
