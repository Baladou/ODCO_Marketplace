                    ...
                    @if($i == 0)
                        <!-- Third Slide -->
                            <div class="item active">
                                ...
                                <!-- Slide Background -->
                                <img src="{{url('/')}}/images/sliders/{{$sliders[$i]->image}}" alt="Bootstrap Touch Slider"  class="slide-image"/>
                            ...
                            <div class="col-md-6 col-sm-12">
                                <div class="single-featured-area">
                                    <a href="{{url('/category')}}/{{$fcategory->slug}}">
                                        <img class="featured-img" src="{{url('/')}}/images/categories/{{$fcategory->feature_image}}" alt="">
                            ...
                            <div class="col-md-3 col-sm-6">
                                <div class="single-featured-area">
                                    <a href="{{url('/category')}}/{{$fcat->slug}}">
                                        <img class="featured-img" src="{{url('/')}}/images/categories/{{$fcat->feature_image}}" alt="">
                                        <div class="product-feature-content">
                                            <h3>{{$fcat->name}}</h3>
                        ...
                        <div class="product-imgBlog-fullDiv">
                            ...
                            <div class="col-md-4">
                                <a href="{{$banner->link}}" target="_blank">
                                    <img src="{{url('/')}}/images/brands/{{$banner->image}}" alt="">
                                </a>
                            </div>
                            @endforeach
                        </div>
                            ...
                            <div class="product-carousel-list">
                                @foreach($latests as $product)
                                    <div class="single-product-carousel-item text-center">
                                        <a href="{{url('/product')}}/{{$product->id}}/{{str_replace(' ','-',strtolower($product->title))}}"> <img src="{{url('/images/products')}}/{{$product->feature_image}}" alt="Product Image" /> </a>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <a href="{{$pagesettings[0]->banner_link}}" target="_blank">
                            <img style="width: 100%;" src="{{url('/images')}}/{{$pagesettings[0]->large_banner}}" alt="">
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="product-subscribe-section text-center wow fadeInUp">
                        <img src="{{url('/images')}}/{{$settings[0]->background}}" alt="">
                        ...
                        <div class="logo-carousel">
                            ...
                            <div class="single-logo-item">
                                <div class="logo-item-inner">
                                    <img src="{{url('/images/brands')}}/{{$brand->image}}" alt="">
                                </div>
                            </div>
                            @endforeach
