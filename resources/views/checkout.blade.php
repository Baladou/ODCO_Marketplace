                            ...
                            <div class="row">
                                    ...
                                    <div class="pricing-list">
                                        <table class="table">
                                            ...
                                            @foreach($cartdata as $cart)
                                                <tr>
                                                    ...
                                                    <td>{{$cart->quantity}}</td>
                                                    <td>{{$cart->cost}}{{$settings[0]->currency_sign}}</td>
                                                </tr>
                                            @endforeach
                                            </tbody>
                                        </table>
                                        <table class="table">
                                            <tr id="shipshow">
                                                ...
                                                <td width="20%"><strong><span id="ship-cost">{{round($settings[0]->shipping_cost,2)}}</span>{{$settings[0]->currency_sign}}</strong></td>
                                            </tr>
                                            <tr>
                                                <td><h3>{{$language->total}}:</h3></td>
                                                <td width="20%"><h3><span id="total-cost">{{round($total,2)}}</span>{{$settings[0]->currency_sign}}</h3></td>
                                            </tr>
                                        </table>
                                    </div>
                                </div>
                                <form  action="" method="post" id="payment_form">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                        <div class="billing-details-area">
                                            <h2 class="signIn-title">Détails de la facturation</h2>
                                            <hr/>
                                            <div class="form-group">
                                                <select class="form-control" onChange="sHipping(this)" id="shipop" name="shipping" required>
                                                    <option value="shipto" selected>Envoyer à l'adresse</option>
                                        ...
                                        @if(Auth::guard('profile')->guest())
                                            <div class="form-group">
                                                <label for="shippingFull_name">Nom et prénom <span>*</span></label>
                                                <input type="text" class="form-control" name="name" value="" placeholder="Nom Complet " required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">Numéro de téléphone <span>*</span></label>
                                                <input type="text" class="form-control" name="phone" value="" placeholder="Numéro du téléphone" required>
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="shippingFull_name">Adresse <span>*</span></label>
                                                <input type="text" class="form-control" name="address" value="" placeholder="Adresse" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">Ville <span>*</span></label>
                                                <input type="text" class="form-control" name="city" value="" placeholder="Ville" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">Code Postal <span>*</span></label>
                                                <input type="text" class="form-control" name="zip" value="" placeholder="Code Postale" required>
                                            </div>
                                            <input type="hidden" name="customer" value="0" />
                                        @else
                                            <div class="form-group">
                                                <label for="shippingFull_name">Nom et prénom <span>*</span></label>
                                                <input type="text" class="form-control" name="name" value="{{Auth::guard('profile')->user()->name}}" placeholder="Nom Complet" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">Numéro de téléphone <span>*</span></label>
                                                <input type="text" class="form-control" name="phone" value="{{Auth::guard('profile')->user()->phone}}" placeholder="Numéro du téléphone" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">Email <span>*</span></label>
                                            ...
                                            <div class="form-group">
                                                <label for="shippingFull_name">Adresse <span>*</span></label>
                                                <input type="text" class="form-control" name="address" value="{{Auth::guard('profile')->user()->address}}" placeholder="Adresse" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">Ville <span>*</span></label>
                                                <input type="text" class="form-control" name="city" value="{{Auth::guard('profile')->user()->city}}" placeholder="Ville" required>
                                            </div>
                                            <div class="form-group">
                                                <label for="shippingFull_name">Code Postal <span>*</span></label>
                                                <input type="text" class="form-control" name="zip" value="{{Auth::guard('profile')->user()->zip}}" placeholder="Code Postale" required>
                                            </div>
                                            <input type="hidden" name="customer" value="{{Auth::guard('profile')->user()->id}}" />
                                        @endif
                                            <div class="form-group">
                                                <label>Sélectionner la méthode du paiement <span>*</span></label>
                                                <select name="method" onChange="meThods(this)" class="form-control" required>
                                                    <option value="" selected>Sélectionner la méthode du paiement</option>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                    ...
                                    <div class="shipping-details-area">
                                        ...
                                        <div class="form-group">
                                            <label for="shipingPhone_number">Numéro de téléphone <span>*</span></label>
                                ...
                                <div class="row text-center">
                                    <div class="form-group">
                                        <input class="btn btn-md order-btn" type="submit" value="Commander maintenant">
                                    </div>
                                    {{--<a href="" class="checkOut-btn">Commander en tant qu'utilisateur</a>--}}
                                </div>
                                </form>
                            </div>
                        </div>
