                ...
                <div class="row">
                    <div class="col-lg-6 col-lg-offset-3 col-md-offset-3 col-md-6 col-sm-12 col-xs-12">
                        <div class="signIn-area">
                            <h2 class="signIn-title">Espace Coopérative</h2>
                            <hr/>
                            <form action="{{ route('vendor.login.submit') }}" method="POST">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6 col-xs-12">
                                            <a href="{{route('vendor.reg')}}">Créer une nouvelle boutique</a>
                                        </div>
                                        <div class="col-md-6 col-sm-6 col-xs-12 text-right">
                                            <a href="{{route('vendor.forgotpass')}}">Mot de passe oublié ?</a>
                                        </div>
                                    </div>
                                </div>
                                <div id="resp">
                                ...
                                <div class="form-group">
                                    <input class="btn btn-md login-btn" type="submit" value="Se connecter">
                                </div>
                            </form>
                        </div>
                    </div>
